...
import { generateCriancasPdf } from "@/lib/participantes-export";
...
export async function GET(request: Request) {
  try {
    ...
    const pdf = generateCriancasPdf(participantes, evento.nome, evento.data);
    const filename = `criancas-${eventoId}.pdf`;
